var appControllers = angular.module("appControllers", [ 'fitnessapp.directives']);



appControllers.controller('goalsCtrl', function($http, $scope,$sce, panel, editpanel,  alert) {
            ...
            }).controller('usersCtrl', function($http, $scope, panel, editpanel,  alert) {
